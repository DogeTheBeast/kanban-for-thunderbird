  ...
  onStartup() {
    ...
    if (calendarItemDetails) {
      ...
      if (calendarItemDetails.default_icon) {
        calendarItemDetails.default_icon = this.extension.baseURI.resolve(localize(calendarItemDetails.default_icon));
      }

      if (calendarItemDetails.default_content) {
        calendarItemDetails.default_content = this.extension.baseURI.resolve(localize(calendarItemDetails.default_content));
      }
